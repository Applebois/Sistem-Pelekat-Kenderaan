        ...
        <div class="article">
          ...
          <div class="post_content">
				...
				<tbody>
					<tr>
					<?php
			$sql ="select DISTINCT maklumat_pelajar.id,pendaftaran_pelajar.mpID from maklumat_pelajar INNER JOIN pendaftaran_pelajar on maklumat_pelajar.id = pendaftaran_pelajar.mpID";
			...
			$count = 1;
					...
					$ro = mysqli_fetch_array($rs,MYSQLI_ASSOC);
						{
							?>
						<a href="butirankenderaan.php?id=<?php echo $row['id'];?>"><?php echo $ro['nama'];?></a>
                            <?php
						} ?> </td>
                                        <td style="text-align:center" > <?php echo $ro['noic']; ?> </td>
